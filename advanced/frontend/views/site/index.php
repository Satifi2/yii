...
<head>
    ...
    <meta name="description" content="BOSHATEAM: Nuclear Contamination Homepage">
    <meta name="author" content="BOSHATEAM">
    ...
    <title>BOSHATEAM: Nuclear Contamination Homepage</title>
    ...
    <div id="main-navigation" class="navbar navbar-inverse navbar-fixed-top smoothtransition fadeInDown sb-slide" data-wow-delay="1s" role="navigation">
        <div class="container smoothtransition">
            <div class="navbar-header">
                ...
                <h2><a class="navbar-brand" href="index.php">Nuclear Accident</a></h2>
            </div>
    ...
    <header id="headerwrap" class="fullscreen">
        <div class="vertical-center">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="fancy wow fadeInDown" data-wow-delay="1.5s"><span><strong>BOSHATEAM</strong></span></h3>
                        <h1 class="mb30 wow fadeInUp" data-wow-delay="2s">WELCOME TO NUCLEAR ACCIDENT</h1>
        ...
        <div class="section-inner nopaddingbottom">
            <div class="container">
                ...
                <div class="row mb100 wow fadeInUp">
                    <div class="col-md-6">
                        <p>这个网站是南开大学《互联网数据库开发》课程BOSHATEAM小组的小组作业。网站中展现了与俄乌战争有关的<strong>不同数据</strong>，包括<strong>战线图、损失数据图表、时间线及重大事件、纽约时报新闻搬运以及用到的武器展示模块</strong>，并在最后附上了建议与反馈模块。我们以用户体验作为第一指标，选取了合适的网站模板并精心设计布局，保证用户访问网站时得到良好体验的同时，能够获取到一些有用的信息。</p>
                        <p>我们的小组成员包括：李星谊、王健行、杜怡兴、杨淇（从左到右），您可以将鼠标悬停到对应的头像上，以查看我们的姓名、学号及座右铭。</p>
        ...
        <div class="container" id="content">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h2 class="section-heading"><strong>Timeline</strong> Of the Historical nuclear accident</h2>
                    <a href="<?php echo Url::to(['time-info/index']); ?>" class="btn btn-theme" target="_blank">learn more >></a>
                    <ul class="timeline">
                        <li class="event" data-date="1957/9/29">
                            <h3>Kyshtym Disaster, Soviet Union </h3>
                            <p>
                            This disaster occurred at the Mayak nuclear fuel reprocessing plant in the Soviet Union. A chemical explosion within a storage tank caused significant radiation contamination. An estimated 200 possible cancer fatalities were reported, although exact figures remain uncertain.
                            </p>
                        </li>
                        <li class="event" data-date="1957/10/10">
                            <h3>Windscale Fire, United Kingdom </h3>
                            <p>
                            At the British atomic bomb project, a fire at the Windscale reactor released substantial amounts of radioactive iodine and polonium into the environment. This incident prompted changes in reactor design and safety procedures​.
                            </p>
                        </li>
                        <li class="event" data-date="1979/3/28">
                            <h3>Three Mile Island, United States</h3>
                            <p>The most severe nuclear accident in U.S. history occurred at the Three Mile Island plant in Pennsylvania. A valve failure led to the leakage of radioactive coolant and a partial meltdown of the reactor core. While there were no immediate casualties, the incident led to widespread public concern over nuclear safety.
                            </p>
                        </li>
                        <li class="event" data-date="1986/4/26">
                            <h3>Chernobyl Disaster, Soviet Union </h3>
                            <p>
                            Widely considered the worst nuclear disaster in history, the Chernobyl accident occurred during a flawed reactor systems test, leading to an explosion and fire that destroyed Unit 4 of the plant. The release of massive amounts of radiation affected large parts of Europe, resulting in the evacuation of about 220,000 people and long-term health effects, including cancer cases
                            </p>
                            
                        </li>
                        <li class="event" data-date="2011/3/11">
                            <h3>Fukushima Daiichi, Japan</h3>
                            <p>
                            Triggered by a massive earthquake and tsunami, this accident led to the failure of power and cooling systems at Fukushima Daiichi nuclear power plant, causing meltdowns in three of the reactors. The release of radiation led to the evacuation of nearly half a million residents. While there were no immediate deaths from radiation, the long-term effects and environmental contamination have been significant​
                            </p>
                        </li>
                        
                        <li class="event" data-date="2023/8/24">
                            <h3>Fukushima Wastewater Release Japan</h3>
                            <p>
                            Following the 2011 Fukushima nuclear disaster, Japan has been managing a significant amount of contaminated water. Plans have been made to release this water into the ocean, which has sparked international debate and concern.
                            </p>
                            <p>
                            The Japanese government and various scientific bodies assert that the water will be treated and diluted to safe levels before release, minimizing environmental and health risks. However, there is ongoing debate about the long-term impacts of this decision on marine life and the surrounding environment​
                            </p>
                        </li>
                        <li class="event" data-date="2023/12/5">
                            <h3>Sellafield Leak, United Kingdom </h3>
                            <p>
                            The Guardian, citing official documents, revealed that the Sellafield nuclear facility in the UK experienced a crack in its storage for toxic radioactive waste in 2019, leading to potentially severe consequences. The documents suggest that the leakage could continue until 2050 and may contaminate groundwater if the situation worsens. An anonymous expert indicated that the facts and potential risks of the leak have been tightly concealed by officials.
                            </p>
                        </li>                       
                    </ul>
                </div>
    ...
    <section id="news" class="divider-wrapper-a section-wrapper opaqued" data-parallax="scroll" data-image-src="assets/img/bg/bg2.jpg" data-speed="0.7">
        <div class="section-inner nopaddingbottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 wow fadeInDown">
                        <h2 class="section-heading"><strong>Nuclear Contamination News</strong> Posts</h2>
    ...
    <section id="login" class="divider-wrapper-a section-wrapper opaqued" data-parallax="scroll" data-image-src="assets/img/bg/bg1.jpg" data-speed="0.7">
        <div class="section-inner">
            <div class="container">
                <div class="row wow fadeInUp">
                    <div class="col-md-12 centered">
                    <div class='btn btn-theme btn-white pull-left subscribe-submit' style="font-size:30px;">BOSHATEAM</div>
    ...
    <footer id="footerwrap">
        ...
        <div id="lowerfooter">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p>Copyright 2023 | Designed By Distinctive Themes and Team BOSHATEAM.</p>
                    </div>
                </div>
            </div>
        </div>
